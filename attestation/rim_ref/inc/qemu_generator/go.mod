...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20250301145124-3f13023f5f91
...
replace github.com/containerd/containerd => github.com/confidential-containers/containerd v1.6.7-0.20221123142530-25f68aa818ec
