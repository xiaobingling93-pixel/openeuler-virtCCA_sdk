...
import (
	...
	drvs "github.com/kata-containers/kata-containers/src/runtime/pkg/device/drivers"
)
...
func (vfioDev VFIODevice) QemuParams(config *Config) []string {
	...
	if strings.HasPrefix(vfioDev.DevfsDev, drvs.IommufdDevPath) {
		qemuParams = append(qemuParams, "-object")
