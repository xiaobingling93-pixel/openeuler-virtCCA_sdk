...
PsiInitializer::PsiInitializer() : opts_(DG_InitPsiOpts()) {}

int PsiInitializer::InitializeTeeCtx(void *teeConfig, int worldSize, DG_TeeCtx **teeCtx)
{
...
void PsiInitializer::ReleaseTeeCtx(DG_TeeCtx **teeCtx)
{
    if (teeCtx && *teeCtx) {
